			...
			_library = new Dictionary<EntityRequestType, Func<Endpoint>>
				{
					...
					{EntityRequestType.Board_Read_PowerUpData, () => new Endpoint(RestMethod.Get, "boards", "_id", "plugindata")},
					...
					{EntityRequestType.Card_Read_PowerUpData, () => new Endpoint(RestMethod.Get, "cards", "_id", "plugindata")},
					...
					{EntityRequestType.Organization_Read_PowerUpData, () => new Endpoint(RestMethod.Get, "organizations", "_id", "plugindata")},
